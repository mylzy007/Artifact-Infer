import os
from src.services.nanovllm_chunked import LLM
from src.services.nanovllm_chunked.config import Config
# 假设你的 SamplingParams 在这，如果不对请替换为你的实际导入路径
from src.services.nanovllm_chunked import SamplingParams 
from transformers import AutoTokenizer

def main():
    path = os.path.expanduser("~/models/Qwen3-4B/")
