"""Recipe: EP-LL MoE reference path with torch dispatch/GEMM.
...
Local ModelRunner graph:
    ...
    MoeBackend(ep_ll_torch) -> DispatchEPLL + ExpertsEPLL + CombineEPLL
    DispatchEPLL -> torch host bucketing
    ExpertsEPLL.run_experts_ll -> torch_masked_grouped_gemm
"""
...
- DispatchEPLL -> torch host bucketing
- MoeBackend.run_experts_ll -> torch_masked_grouped_gemm
"""
