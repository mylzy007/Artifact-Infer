"""Recipe: single-rank MoE reference path with torch fused-MoE.
...
Local ModelRunner graph:
    ...
    MoeBackend(torch) -> Dispatch + Experts + Combine
    Experts.run_experts -> torch_fused_moe
"""
...
- MoeBackend.run_experts -> torch_fused_moe
"""
